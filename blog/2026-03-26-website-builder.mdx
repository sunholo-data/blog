  ...
  tiers={[
    {
      ...
      strength: 85,
      strengthLabel: "Speed",
      description: "Runs in-browser via WASM with Google Gemini. Fast, lightweight, no server needed.",
      points: [
    ...
    {
      name: "Claudette Mouser",
      color: "#7C3AED",
      icon: "☁️",
      strength: 95,
      strengthLabel: "Quality",
      description: "AILANG Cloud builds powered by Claude. Higher quality layouts, smarter content decisions.",
      points: [
        "Server-side via AILANG Cloud",
        "Powered by Claude",
        "No API key required (admin access)",
        "Best for polished, production-ready sites",
      ],
    },
    {
      name: "Sir Claude Fixalot",
      color: "#D97706",
      icon: "🔧",
      strength: 90,
      strengthLabel: "Quality",
      description: "Uses your own Anthropic API key for premium Claude-powered builds. You control the cost.",
      points: [
        "Premium Claude-powered builds",
        "Bring your own Anthropic API key",
        "Full cost control",
        "High quality with direct API access",
      ],
    },
    {
      name: "Opal Cadillac",
      ...
      strength: 88,
      strengthLabel: "Quality",
      description: "Brings OpenAI's GPT models to your builds with your own API key.",
      points: [
        "Powered by OpenAI GPT models",
        "Bring your own OpenAI API key",
        "Alternative model choice",
        "Familiar for OpenAI users",
      ],
    },
  ]}
/>
