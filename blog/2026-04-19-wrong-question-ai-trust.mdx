...
This was why we started developing [AILANG](https://ailang.sunholo.com/), an [AI-first programming language](https://ailang.sunholo.com/docs/why-ailang). It's made by consulting with AIs for its design, for AIs to use. From AILANG's vision document:
...
<SharedTopic topic="trust" current="/blog/wrong-question-ai-trust" />
{/* TOPIC_RESOURCES_END */}
