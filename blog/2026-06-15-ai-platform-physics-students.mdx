...
AI in Physics Learning and Assessment (AIPLA) is a three-year research programme investigating how generative AI can be meaningfully integrated into upper-secondary physics education in Denmark. It is an initiative started by Prof. Jesper Bruun of the **Institut for Naturfagenes Didaktik**, Københavns Universitet and affiliated with the AEID programme of the [Pioneer Centre for Artificial Intelligence](https://www.aicentre.dk/p1-programs/ai-in-education)
...
A big focus for my AI platform engineering for clients is:
