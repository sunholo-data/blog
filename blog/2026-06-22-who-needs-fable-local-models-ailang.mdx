...
And so last weekend, with the maturity of Motoko, Qwen3.6 released (the latest open source coding champion) and my new [Mac Studio M4 128GB](https://www.apple.com/dk/mac-studio/) I set up a loop within Claude Code to create its potential successor, Motoko.

The loop would:

- Read the mission document with key goal: “Improve motoko running Qwen3.6 in AILANG benchmarks”. It started at ~23% pass rate (vs Fables 97% one-shot performance)
