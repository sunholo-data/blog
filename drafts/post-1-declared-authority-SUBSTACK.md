...
*This is the second post in a six-part series on AI delegation, trust, and authority. Read the [series introduction here](https://www.sunholo.com/blog/wrong-question-ai-trust).*

---

[IMAGE: Screenshot of Jason Lemkin's X thread describing the Replit incident — credit: Jason Lemkin on X (https://x.com/jasonlk/status/1946069562723897802)]
...
[IMAGE: Screenshot of the TierComparison showing three tiers — Prompt Instructions (string), Infrastructure Controls (wall), Language-Level Capabilities (steel)]
...
[IMAGE: Screenshot of the CodeCompare showing "Without AILANG" (hope-based) vs "AILANG" (compiler-enforced)]
